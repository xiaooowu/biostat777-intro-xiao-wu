...
\[**Source**: [Cometeer James Hoffmann Taste Test Scoresheet](https://cometeer.com/pages/the-great-american-coffee-taste-test?srsltid=AfmBOoqU_dtUSsWODwHozAagupTV0IlXbaCbNKf9GpdEiPce9l_meOgK)\]
...
::: {.column-margin}
The R packages used in the following analysis include Tidyverse [@tidyverse], gridExtra [@gridExtra], grid [@grid] and RColorBrewer [@RColorBrewer].
:::
